                   ...
                   <tr>
                    ...
                    <td>
                      <div class="btn-group">
                        ...
                        <a href="{{url('/')}}/cliente_tres/{{$value["id"]}}" class="btn btn-warning btn-sm">
                          
                          <i class="fas fa-pencil-alt text-white"></i>
                        </a>

                          {{--borrar sin filtro--
                          <form method="POST" action="{{url('/')}}/cliente_tres/{{$value["id"]}}">
  ...
  <div class="modal" id="crearCentro">
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <form action="{{ url('/')}}/cliente_tres" method="POST" enctype="multipart/form-data">
          @csrf
         ...
         @foreach ($aysen_s as $key => $value)
          ...
          <div class="modal" id="editarCentro">
            ...
            <div class="modal-dialog">
              ...
              <div class="modal-content">
              <form action="{{ url('/')}}/cliente_tres/{{$value->id}}" method="POST" enctype="multipart/form-data">
                  @method('PUT')
                  @csrf
