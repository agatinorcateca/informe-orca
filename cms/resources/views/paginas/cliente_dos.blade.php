      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          ...
          <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item active">Multiexportfoods</li>
        ...
        <div class="col-12">
          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              <table class="table table-bordered table-striped dt-responsive" with="100%" id="tablaMultiexport">
                   ...
                   <tr>
                    ...
                    <td>
                      <div class="btn-group">
                        ...
                        <a href="{{url('/')}}/cliente_dos/{{$value["id"]}}" class="btn btn-warning btn-sm">
                        ...
                        {{--borrar sin filtro--
                        <form method="POST" action="{{url('/')}}/cliente_dos/{{$value["id"]}}">
  ...
  <div class="modal" id="crearCentro">
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <form action="{{ url('/')}}/cliente_dos" method="POST" enctype="multipart/form-data">
          @csrf
         ...
         @foreach ($multi_s as $key => $value)
          ...
          <div class="modal" id="editarCentro">
            ...
            <div class="modal-dialog">
              ...
              <div class="modal-content">
              <form action="{{ url('/')}}/cliente_dos/{{$value->id}}" method="POST" enctype="multipart/form-data">
                  @method('PUT')
                  @csrf
