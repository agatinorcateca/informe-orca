  ...
  <section class="content-header">
    ...
    <div class="container-fluid">
      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6 ">
           <h1>.::<i class="fas fa-clipboard-list">   Informe AquaChile::.</i></h1>
            ...
            <!--Fin barra totales, operativos y cese-->
        <div class="col-sm-6">
          ...
          <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item active">Aqua</li>
        ...
        <div class="col-12">
          ...
          <div class="card">
            <div class="card-header">
              ...
              <a href="{{ route('descargarPDF')}}" target="blank">
              ...
              <a href="{{ route('enviarPDFaqua')}}" target="blank">
            ...
            <div class="card-body">
                ...
                <div class="col-md-4">
                  ...
                  <button type="button" name="refresh" id="refresh" class="btn btn-default" alt="Refrescar">
              ...
              <table class="table table-bordered table-striped dt-responsive" with="100%" id="aquatable">
                   ...
                   <tr>
                    ...
                    <td>
                      <div class="btn-group">
                        ...
                        <a href="{{url('/')}}/aqua/{{$value["id"]}}" class="btn btn-warning btn-sm">
                          <i class="fas fa-pencil-alt text-white"></i>
                        </a>

                        {{--delete con ventana emergente sweetalert
                       
                        <button class="btn btn-danger btn-sm eliminarRegistro" action="{{url('/')}}/aqua/{{$value["id"]}}" method="DELETE" pagina="aqua">
                          @csrf 
                        ...
                        {{--borrar sin filtro
                        <form method="POST" action="{{url('/')}}/aqua/{{$value["id"]}}">
  ...
  <div class="modal" id="crearCentro">
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <form action="{{ url('/')}}/aqua" method="POST" enctype="multipart/form-data">
          @csrf
            ...
            <div class="pb-2">
              ...
              <div class="form-group my-2 text-center">
                ...
                <div class="btn btn-default btn-file">
                  ...
                  <input type="file" name="lugar" required>
         ...
         @foreach ($aqua_s as $key => $value)
          ...
          <div class="modal" id="editarCentro">
            ...
            <div class="modal-dialog">
              ...
              <div class="modal-content">
              <form action="{{ url('/')}}/aqua/{{$value->id}}" method="POST" enctype="multipart/form-data">
                  @method('PUT')
                  @csrf
    ...
    <div class="modal-dialog modal-sm">
      <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <div class="input-group mb-3">                  
               <?php                                                        
                 $ceseaqua = DB::table('totalcentros')
                          ->where( 'estado', 'cese')
                          ->whereIn('id_cat', [1])
                          ->get('titulo_centro');                                      
                ?>                            
                  @foreach ($ceseaqua as $element => $value)
    ...
    <div class="modal-dialog modal-sm">
      <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <div class="input-group mb-3">                  
               <?php                                                        
                 $operativosaqua = DB::table('totalcentros')
                          ->where( 'estado', 'operativo')
                          ->whereIn('id_cat', [1])
                          ->get('titulo_centro');                                      
                ?>  
                                          
                  @foreach ($operativosaqua as $element => $value)
